...
global MALESHEEP FEMALESHEEP MALEWOLF FEMALEWOLF SHEEP_ENERGY WOLF_ENERGY MAX_SHEEP_RATION MAX_WOLF_RATION GRASS BORDER 
global SHEEP_REPRODUCTION_AGE WOLF_REPRODUCTION_AGE REPRODUCTION_SHEEP_RATION REPRODUCTION_WOLF_RATION ;     
    ...
    for i=2:1:m-1;
       for j=2:1:n-1
            if extanimalgrid(i,j)==FEMALESHEEP && extrationgrid(i,j)>=REPRODUCTION_SHEEP_RATION && extagegrid(i,j)>= SHEEP_REPRODUCTION_AGE
            ...
            if extanimalgrid(i,j)==FEMALEWOLF && extrationgrid(i,j)>=REPRODUCTION_WOLF_RATION && extagegrid(i,j)>= WOLF_REPRODUCTION_AGE
                        N=newanimalgrid(i-1,j);
                        S=newanimalgrid(i+1,j);
                        E=newanimalgrid(i,j-1);
                        W=newanimalgrid(i,j+1);
